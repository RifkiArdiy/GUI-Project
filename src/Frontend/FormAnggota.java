...
public class FormAnggota extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<Anggotas> list = new Anggotas().getAll();
        Object rowData[] = new Object[4];
        
        tblAnggota.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (Anggotas agt : list)
        {
    ...
    {
        String[] kolom = {"ID", "Nama", "Alamat", "Telepon"};
        ArrayList<Anggotas> list = new Anggotas().search(keyword);
        Object rowData[] = new Object[4];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggotas agt = new Anggotas().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        agt.delete();
        kosongkanForm();
        tampilkanData();
