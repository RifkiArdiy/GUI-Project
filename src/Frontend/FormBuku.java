...
public class FormBuku extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<Bukus> list = new Bukus().getAll();
    ...
    {
        String[] kolom = {"ID", "Kategori", "Judul", "Penulis", "Penerbit"};
        ArrayList<Bukus> list = new Bukus().search(keyword);
        Object rowData[] = new Object[5];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        DefaultTableModel model = (DefaultTableModel) tblBuku.getModel();
        int row= tblBuku.getSelectedRow();
        Bukus buku = new Bukus().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();                                     
