...
public class Bukus {
    ...
    public Bukus(Kategori kategori, String judul, String penerbit, String penulis)
    {
        this.kategori = kategori;
        this.judul = judul;
        this.penerbit = penerbit;
    ...
    public Bukus getById(int id)
{
    Bukus buku = new Bukus();
    ...
    public ArrayList<Bukus> getAll()
    {
        ArrayList<Bukus> ListBuku = new ArrayList<>();
    ...
    public ArrayList<Bukus> search(String keyword)
{
    ArrayList<Bukus> ListBuku = new ArrayList<>();
